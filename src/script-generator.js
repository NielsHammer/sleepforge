...
const PHILOSOPHERS = {
  ...
  nietzsche: {
    ...
    moments: [
      ...
      "Walking the Swiss Alps above Sils-Maria, where the thought of eternal recurrence first struck him",
  ...
  kierkegaard: {
    ...
    era: "Denmark, 1813-1855",
    core: "Subjectivity is truth. The leap of faith cannot be reasoned into — it must be lived.",
    moments: [
      "Writing Either/Or under a pseudonym, arguing both sides of a life with himself",
      "Breaking his engagement to Regine Olsen — choosing the lonely path of the spirit",
      "Sitting in a Copenhagen café, writing in his journal by candlelight",
      "Describing Abraham raising the knife over Isaac — the terrifying suspension of the ethical",
      "Walking the streets of Copenhagen alone at night, thinking through the stages of existence",
      "Writing The Sickness Unto Death on despair as the condition of not being oneself",
      "Publishing Attack Upon Christendom — his final assault on the church he loved",
      "Collapsing in the street in Copenhagen, whispering that he had done what he came to do",
    ],
    themes: ["leap of faith, subjectivity, despair, stages of existence, anxiety, the individual, authentic choice"],
  },
  schopenhauer: {
    name: "Arthur Schopenhauer",
    era: "Germany, 1788-1860",
    core: "The world is will and representation. Desire is suffering. Silence and art are the only peace.",
    moments: [
      "Writing The World as Will and Representation alone in a Frankfurt apartment",
      "Sitting in silence at his harpsichord, the only relief from the endless striving of the will",
      "Watching his poodle Atma by the window and calling it his sole companion",
      "Teaching that the will to live — blind and insatiable — is the source of all suffering",
      "Reading a Buddhist sutra and recognizing his own philosophy looking back at him",
      "Watching a flame gutter and go out, noting that the will persists even as the individual perishes",
      "Explaining that music is the purest expression of the will itself",
      "Dying peacefully in his armchair, having outlived his irrelevance and become famous at last",
    ],
    themes: ["will, suffering, resignation, aesthetic contemplation, pessimism, compassion, individuation"],
  },
  sartre: {
    name: "Jean-Paul Sartre",
    era: "France, 1905-1980",
    core: "Existence precedes essence. We are condemned to be free. Bad faith is the refusal to choose.",
    moments: [
      "Writing Being and Nothingness in a Paris café during the German occupation",
      "Lecturing on existentialism to a crowd of hundreds spilling into the street",
      "Sitting with Simone de Beauvoir in the Café de Flore, arguing over freedom and commitment",
      "Writing No Exit in one sitting — 'Hell is other people'",
      "Refusing the Nobel Prize, explaining that no writer should become an institution",
      "Describing the waiter who plays at being a waiter — the classic image of bad faith",
      "Working through the night on the Critique of Dialectical Reason, ruining his health with stimulants",
      "Standing on a box at the Renault factory gates, speaking to workers who barely recognized him",
    ],
    themes: ["freedom, bad faith, existence, nothingness, responsibility, authenticity, commitment, absurdity"],
  },
  camus: {
    name: "Albert Camus",
    era: "Algeria/France, 1913-1960",
    core: "The absurd is the confrontation between human need for meaning and the universe's silence. One must imagine Sisyphus happy.",
    moments: [
      "Writing The Myth of Sisyphus in occupied Paris, as an act of quiet defiance",
      "Watching the sea at the beach near Algiers, where he first understood what it meant to be alive",
      "Sitting with the manuscript of The Stranger, hearing Meursault's voice as his own",
      "Arguing with Sartre in Saint-Germain-des-Prés about whether revolution justifies murder",
      "Receiving the Nobel Prize, dedicating it to his teacher who believed in him",
      "Walking the streets of Oran during the fictional plague, understanding collective suffering",
      "Writing The Fall in a single month, the confession of a man who let someone drown",
      "Standing in the sunlight of Algeria at dawn, feeling that life needs no justification",
    ],
    themes: ["absurdity, rebellion, solidarity, silence of the universe, happiness, mortality, Mediterranean light"],
  },
  spinoza: {
    name: "Baruch Spinoza",
    era: "Amsterdam, 1632-1677",
    core: "God and nature are one. All things follow from necessity. Freedom is understanding why you do what you do.",
    moments: [
      "Grinding lenses in his small workshop, earning just enough to keep thinking",
      "Being excommunicated from the Amsterdam synagogue at twenty-three — alone in the world",
      "Writing the Ethics in the geometric style of Euclid, building truth proof by proof",
      "Explaining to a correspondent that God has no will, no plan, no emotion — only necessity",
      "Watching dust settle in his workshop, knowing that even the smallest particle obeys the same laws as the stars",
      "Refusing a professorship in Heidelberg to preserve his freedom of thought",
      "Writing the Theological-Political Treatise anonymously, knowing it would be banned",
      "Dying of a lung disease from years of inhaling lens dust, at peace with the necessity of it",
    ],
    themes: ["God, nature, necessity, freedom, substance, eternity, intellectual love of God, pantheism"],
  },
  hume: {
    name: "David Hume",
    era: "Scotland, 1711-1776",
    core: "Reason is the slave of the passions. Causation is habit, not logic. We cannot know what we cannot feel.",
    moments: [
      "Writing A Treatise of Human Nature at twenty-six and watching it fall dead from the press",
      "Sitting by the fire in Edinburgh, skeptical of everything including his own skepticism",
      "Explaining to a student that he cannot prove the sun will rise tomorrow — only that it always has",
      "Writing the Dialogues Concerning Natural Religion on his deathbed, refusing to suppress them",
      "Cheerfully telling Boswell he feared death not at all, while Boswell waited for him to recant",
      "Challenging the idea of personal identity — no self, just a bundle of impressions",
      "Walking the streets of Edinburgh on a warm evening, content in his skepticism",
      "Receiving Adam Smith's letter of admiration — two great Scots recognizing each other",
    ],
    themes: ["skepticism, causation, impression, habit, passion, personal identity, custom, naturalism"],
  },
  kant: {
    name: "Immanuel Kant",
    era: "Prussia, 1724-1804",
    core: "The mind shapes experience. Act only by principles you could will to be universal laws. The starry sky above and the moral law within.",
    moments: [
      "Waking at five each morning with the precision of a town clock, walking the same path through Königsberg",
      "Writing the Critique of Pure Reason after eleven years of silence",
      "Explaining the categorical imperative to a student who struggled with every word",
      "Sitting at his study window, watching the lime trees he could see from his chair for forty years",
      "Describing the Copernican revolution in philosophy — the mind structures reality, not the reverse",
      "Refusing to leave Königsberg his entire life, traveling only in thought",
      "Writing the Groundwork for the Metaphysics of Morals — three hours a day, no more",
      "Dictating his last lecture, barely able to speak, still insisting on precision",
    ],
    themes: ["duty, categorical imperative, pure reason, phenomena, noumena, moral law, autonomy, the sublime"],
  },
  hegel: {
    name: "Georg Wilhelm Friedrich Hegel",
    era: "Germany, 1770-1831",
    core: "History is the unfolding of spirit toward self-knowledge. Thesis, antithesis, synthesis — contradiction is the engine of everything.",
    moments: [
      "Finishing the Phenomenology of Spirit the night before Napoleon entered Jena",
      "Watching Napoleon ride through Jena on horseback and calling him the World Soul on horseback",
      "Explaining to students in Berlin that the rational is real and the real is rational",
      "Writing the Science of Logic alone in Nuremberg, building his cathedral of concepts",
      "Lecturing on the philosophy of history — one great hall, hundreds of students, years of dense thought",
      "Describing the master-slave dialectic: that the slave, through labor, eventually gains more than the master",
      "Sitting in the twilight of his study in Berlin, the owl of Minerva spreading its wings",
      "Dying suddenly of cholera in Berlin at sixty-one, at the height of his influence",
    ],
    themes: ["dialectic, Geist, history, freedom, contradiction, synthesis, recognition, the absolute"],
  },
  wittgenstein: {
    name: "Ludwig Wittgenstein",
    era: "Austria/England, 1889-1951",
    core: "The limits of my language are the limits of my world. Whereof one cannot speak, thereof one must be silent.",
    moments: [
      "Writing the Tractatus Logico-Philosophicus in the trenches of World War One",
      "Handing Russell the Tractatus manuscript and explaining it solved all of philosophy",
      "Living in a village in rural Austria as a schoolteacher, building a house for his sister with obsessive precision",
      "Arriving in Cambridge with nothing but a suitcase and the belief that he had to think properly",
      "Saying to a student: 'Don't think — look!' — pointing out the window at children playing",
      "Pacing his rooms in Trinity College for hours, in the grip of a philosophical problem",
      "Writing the Philosophical Investigations — every sentence cut and recut over thirty years",
      "Dying in Cambridge, telling his friends: 'Tell them I've had a wonderful life'",
    ],
    themes: ["language, meaning, silence, logic, forms of life, grammar, private language, showing vs saying"],
  },
  heidegger: {
    name: "Martin Heidegger",
    era: "Germany, 1889-1976",
    core: "Being has been forgotten. We are thrown into existence without choosing it. Death is the horizon that makes life authentic.",
    moments: [
      "Writing Being and Time in a small mountain hut above Todtnauberg, in snow and silence",
      "Teaching his students that Dasein — being-there — is always already in the world",
      "Walking forest paths near Freiburg at dusk, thinking about the clearing where Being shows itself",
      "Describing anxiety as the mood that strips away all distraction and reveals bare existence",
      "Sitting in the hut at Todtnauberg, unable to explain or apologize for his past",
      "Explaining that technology conceals being by turning everything into standing reserve",
      "Reading the pre-Socratics — Parmenides, Heraclitus — as if for the first time",
      "Dying in Freiburg and being buried in Messkirch, the village where he was born",
    ],
    themes: ["Being, Dasein, thrownness, authenticity, death, anxiety, technology, the clearing, temporality"],
  },
};
